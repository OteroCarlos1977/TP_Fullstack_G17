...
************************************************************************** */
      ...
      async function listarUsuarios() {
        try {
            const response = await fetch(API_REST +'usuarios');
            const response2 = await fetch(API_REST +'auth');
...
************************************************************************** */
    ...
    nuevoUsuario.addEventListener('submit', async (event) => {
        ...
        try {
            const respuesta = await fetch(API_REST +'usuarios', {
                method: 'POST',
                headers: {
...
************************************************************************** */
    ...
    elimId.addEventListener('click', async (event) => {
        ...
        try {
            const response = await fetch(`${API_REST}usuarios/${userId}`);
...
************************************************************************** */
    ...
    actualUsuId.addEventListener('click', async (event) => {
        ...
        try {
            ...
            const resp = await fetch(`${API_REST}usuarios/${userId}`);
...
************************************************************************** */    
    ...
    async function listarPeliculas() {
        try {
            ...
            const response2 = await fetch(API_REST + 'genero');
...
************************************************************************** */        
    ...
    nuevaPelicula.addEventListener('submit', async (event) => {
        ...
        try {
            const respuesta = await fetch(API_REST + 'movies', {
                method: 'POST',
                body: formData,
            });
...
************************************************************************** */  
    ...
    buscarIPelId.addEventListener('click', async (event) => {
        ...
        try {
            const response = await fetch(`${API_REST}movies/${pelId}`);
